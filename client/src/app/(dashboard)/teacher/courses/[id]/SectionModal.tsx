...
const SectionModal = () => {
	...
	const onSubmit = (data: SectionFormData) => {
		...
		toast.success(`Раздел успешно добавлен/обновлен, но вам нужно сохранить курс для применения изменений`);
		onClose();
	};
		...
		<CustomModal isOpen={isSectionModalOpen} onClose={onClose}>
			<div className="section-modal">
				<div className="section-modal__header">
					<h2 className="section-modal__title">Добавить/Редактировать раздел</h2>
				...
				<Form {...methods}>
					<form onSubmit={methods.handleSubmit(onSubmit)} className="section-modal__form">
						<CustomFormField name="title" label="Название раздела" placeholder="Введите название раздела" />
