...
const Courses = () => {
	...
	if (!user) return <div>Войдите в аккаунт, чтобы просмотреть ваши курсы.</div>;
	if (isError || !courses || courses.length === 0) return <div>Вы еще не записаны ни на один курс.</div>;

	return (
		<div className="user-courses">
			<Header title="Мои курсы" subtitle="Просмотр ваших курсов" />
