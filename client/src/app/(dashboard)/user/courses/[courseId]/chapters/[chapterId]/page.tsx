...
const Course = () => {
	...
	if (!user) return <div>Войдите в аккаунт, чтобы просмотреть этот курс.</div>;
				...
				<Card className="course__video">
					<CardContent className="course__video-container">
						{currentChapter?.video ? (
							...
							<div className="course__no-video">Видео для этой главы недоступно.</div>
						)}
					</CardContent>
				</Card>
						...
						<CardContent className="course__instructor-info">
							<div className="course__instructor-header">
								...
								<div className="course__instructor-details">
									...
									<p className="course__instructor-title">Ведущий UX-дизайнер</p>
								</div>
							</div>
							<div className="course__instructor-bio">
								<p>
									Опытный ведущий UX-дизайнер с более чем 15-летним стажем создания интуитивных и увлекательных
									цифровых решений. Эксперт в руководстве UX-проектами.
								</p>
							</div>
						</CardContent>
					</Card>
