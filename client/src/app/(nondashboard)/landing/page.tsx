		...
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="landing">
			...
			>
				<div className="landing__hero-content">
					...
					<p className="landing__description">
						Это список курсов, на которые вы можете записаться.
						<br />
						Курсы тогда, когда они вам нужны и когда вы их хотите.
					</p>
			...
			>
				...
				<p className="landing__featured-description">
					...
					подготавливающие весь ваш путь обучения для максимальной пользы.
				</p>

				<div className="landing__tags">
					{["веб-разработка", "корпоративные IT", "react nextjs", "javascript", "backend разработка"].map(
						(tag, index) => (
