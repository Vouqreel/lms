			...
			<div className="checkout-details__container">
				...
				<div className="checkout-details__options">
					<div className="checkout-details__guest">
						<h2 className="checkout-details__title">Гостевое оформление заказа</h2>
						<p className="checkout-details__subtitle">
							Введите адрес электронной почты, чтобы получить данные о доступе к курсу и подтверждение заказа. Вы
							можете создать учетную запись после покупки.
						</p>
						<Form {...methods}>
							<form
