		...
		<div className="course-preview">
			<div className="course-preview__container">
				...
				<div>
					...
					<p className="text-gray-400 text-md mb-4">от: {course.teacherName}</p>
					<p className="text-sm text-customgreys-dirtyGrey">{course.description}</p>
				</div>

				<div>
					<h4 className="text-white-50/90 font-semibold mb-2">Содержание курса</h4>
					<AccordionSections sections={course.sections} />
				</div>
			</div>

			<div className="course-preview__container">
				<h3 className="text-xl mb-4">Детали заказа (1 товар)</h3>
				...
				<div className="flex justify-between border-t border-customgreys-dirtyGrey pt-4">
					<span className="font-bold text-lg">Общая сумма</span>
